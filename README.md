...
This repository contains a template for creating an [Azure Static Web Apps](https://docs.microsoft.com/azure/static-web-apps/?WT.mc_id=dotnet-0000-aapowell) projects using Elmish + Fable, Paket and F# Azure Functions.
